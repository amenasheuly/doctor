...
<div class="container">
        ...
        <div class="login-form">
            ...
            session_start();
              if (@$_GET['action'] == "cp"){
             echo "<form action='patient_forget_pass.php?action=cp' method='post'><center>";
        ...
        if (isset($_POST['change_pass'])) {
            ...
            $check = mysqli_query($connection, "SELECT * FROM `patientregistration` WHERE email='".$email."'");
            ...
            while ($row = mysqli_fetch_assoc($check)) {
                ...
                if ($re_pass == $new_pass) {
                   ...
                   if($query = mysqli_query($connection, "UPDATE `patientregistration` SET password ='".$new_pass."' WHERE email='".$email."'")){
